  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/view/main/article/Article_commit')
      },
      {
        path: 'cargorty',
        name: 'cargorty',
        ...
        children: [
          {
            ...
            component: () => import('@/view/main/article/Article_cargorty')
          },
          {
            path: 'update/:id',
            ...
            component: () => import('@/view/main/article/Article_cargorty_update')
          },
          {
            path: 'add',
            name: 'cargorty_add',
